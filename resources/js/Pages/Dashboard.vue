...
const calcTotalPPM = computed(()=>{
    return (sumExentoNeto.value * percentajePPM.value) / 100
})
...
const form = useForm({
    ...
    retencion_42N1: null,
    retencion_42N2: null,
    impuesto_unico_trabajadores: null,
    impuesto_2da_categoria: null,
    total_amount: null,
                ...
                <div class="bg-white dark:bg-gray-800 px-4">
                    <div class="mt-7 overflow-x-auto">
                        ...
                        <table class="w-full whitespace-nowrap dark:bg-gray-800 sm:mt-4 mt-4">
                            ...
                            <tfoot class="bg-gray-600">
                                <tr tabindex="0" class="focus:outline-none border h-16 border-gray-100 rounded">
                                    <td class="">
                                        <div class="flex items-center pl-5">
                ...
                <div class="bg-white dark:bg-gray-800 px-4">
                    <div class="mt-7 overflow-x-auto">
                        <table class="w-full whitespace-nowrap border border-gray-100">
                            ...
                            <tfoot class="bg-gray-600">
                                <tr tabindex="0" class="focus:outline-none rounded h-16">
                                    <td class="">
                                        <div class="flex items-center pl-5">
